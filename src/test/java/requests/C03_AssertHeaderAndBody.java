...
//        Response body contains "Not Found"
        ...
        boolean isContain = responseBody.contains("Not Found");
        assertTrue(isContain);//If the boolean value between parenthesis is TRUE test will pass

//        Response body does not contain "Clarusway"
        assertFalse(responseBody.contains("Clarusway"));//If the boolean value between parenthesis is FALSE test will pass
